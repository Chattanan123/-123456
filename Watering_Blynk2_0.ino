...
Using library Blynk at version 1.2.0 
Using library DHT from .Zip file
Using library Time at version 1.6.1 
 *******************************************************/
#define BLYNK_PRINT Serial

/* Fill-in your Template ID (only if using Blynk.Cloud) */
#define BLYNK_TEMPLATE_ID "TMPL6_fTZy5MV"
#define BLYNK_TEMPLATE_NAME "Watering"
#define BLYNK_AUTH_TOKEN "kH8SgglLB-8QRCS2XK2QgVoD-P4yExL8"
...
char auth[] = "kH8SgglLB-8QRCS2XK2QgVoD-P4yExL8";
...
#define BLYNK_VALVE_2           V4
#define BLYNK_TIMER_1           V5
